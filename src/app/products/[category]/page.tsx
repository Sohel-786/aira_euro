    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-custom_neutral-900 mb-4">Category Not Found</h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-24 relative z-10">
          ...
          >
            <nav className="flex items-center gap-1 md:gap-2 text-xs md:text-sm text-custom_neutral-600 mb-6 overflow-x-auto scrollbar-hide">
              ...
              <LuChevronRight className="w-3 h-3 md:w-4 md:h-4 text-custom_neutral-400 flex-shrink-0" />
              <span 
                className="text-custom_neutral-900 font-medium truncate max-w-[200px] md:max-w-none flex-shrink-0" 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-24">
          {products.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-lg text-custom_neutral-600">No products available in this category.</p>
            </div>
          ) : (
            <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-24">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-lg mb-8 opacity-90">
              Our experts are here to help you find the perfect solution for your application.
            </p>
